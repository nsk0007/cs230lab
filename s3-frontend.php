        ...
        <div class="my-auto">
            <form action="includes/s3-upload-helper.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="file" name="s3-image" id="s3-image" onchange="preview(this)" class="form-control" style="display: name">
                </div>
                <div class="form-group">
                    <button type="submit" name="s3-submit" class="btn btn-outline-success btn-lrg btn-block">Upload</button>
                </div>
            </form>
        </div>
    </div>
